...
class Person
{
    ...
    {
        // Can be writen traditionaly like this
        //person = this;
        //gender = this.Gender;
        //age = this.Age;
        //maritalStatus = this.PersonMaritalStatus;

        // or more fancy way like this using tupple
...
class Descripter
{
    ...
    public static string GetDescriptionMaritalStatus(Person person)
    {
        ...
        // Deconstruct will be invoked automatically by switch statement and return tuple equal like below
        // (person, person.Gender, person.Age, person.PersonMaritalStatus)
        // We just only use 'person' object in the switch
