...
class Program
{
    ...
    private static void WithTask()
    {
        ...
        // Here we use Task.Factory.StartNew instead of Task.Run
        // In its overload method, it provides advanced parameter like cancellationToken, creationOptions, and scheduler
        // If it is used like below, it exactly the same as Task.Run
